...
<body class="bg-dark bg-gradient fw-bold no-repeat">
    <div class="container-fluid">
        <div class="row w-100 p-3">
            ...
            <div class="col-6">
                <h1 class="text-white">Nuevo Sponsor</h1>
                @if ($errors->any())
                ...
                @endif
                <form action="{{route('storeSponsor')}}" class="w-100" method="post" enctype='multipart/form-data'>
                    @csrf
                    <div class="custom-file w-50">
                        <img src="{{ asset('storage/sponsorLogo/preview.png') }}" alt="logo sponsor" class="preview-img" id="img">
                        <input type="file" class="custom-file-input" id="logo" name="logo">
                        <label class="btn bg-light" for="logo">Cambiar imagen</label>
                    </div>
                    <div class="form-group">
                        <label class="text-white" for="sponsorCIF">CIF:</label>
                        <input type="text" class="form-control" id="sponsorCIF" name="sponsorCIF">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sponsorAdress" name="sponsorAdress">
                    </div>
