    ...
    <div class="container-fluid">
        <div class="row w-100 p-3">
            ...
            <div class="col-8">
                <div class="row">
                    <div class="col-10">
                        <h1 class="text-white">Salas disponbiles para {{$insurance -> insuranceName}} </h1>
                    </div>
                    <div class="col-2">
                    ...
                    <div class="row">
                        <div class="col-11">
                            ...
                            @endif
                            @if (count($rooms) == 0)
                                <h3 class="text-white mt-5">No tiene ninguna sala disponible para asegurar actualmente </h3>
                            @elseif(count($rooms)>0)
                                <form action="{{route('admin.insureRoom')}}" method="POST">
                                    @csrf
                                ...
                                <button type="submit" class="btn btn-succes">Asegurar Selección</button>
                            </form>
                            @endif
                        </div>
                      </div>
