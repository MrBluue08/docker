<div class="col-5">
    <nav>
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a  class="nav-link text-white" aria-current="page" href="{{route('admin.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="{{route('listSponsor')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="{{route('listInsurance')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="{{route('listTeam')}}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="{{route('listRoom')}}">
